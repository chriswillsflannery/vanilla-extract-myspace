...
const emptyCssExtractionFile = require.resolve(path__default['default'].join(path__default['default'].dirname(require.resolve('@vanilla-extract/webpack-plugin/package.json')), 'extracted'));
...
function pitch() {
  ...
  childCompiler.getCompiledSource(this).then(({
    source
  }) => {
    const result = integration.processVanillaFile({
      source,
      outputCss,
      filePath: this.resourcePath,
